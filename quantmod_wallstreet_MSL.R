# from GitHub
# https://github.com/amunategui/quantmod-wallstreet
...
bst <- xgboost(data = as.matrix(train[,predictorNames]),
               label = train$outcome,
               verbose=0,  # how verbose the execute in console is
               eta = 0.1,
               gamma = 50, 
               nround = 50,
               colsample_bytree = 0.1,
               subsample = 0.5,  # interesting piece here
