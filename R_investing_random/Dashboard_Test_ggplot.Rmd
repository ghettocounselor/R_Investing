---
title: "FlexDashboard - ggplotly geoms"
output: 
  flexdashboard::flex_dashboard:
    ...
    source_code: embed
---
from https://beta.rstudioconnect.com/jjallaire/htmlwidgets-ggplotly-geoms/htmlwidgets-ggplotly-geoms.html#geom_density 

```{r setup, include=FALSE}
library(ggplot2)
# install.packages('plotly')
library(plotly)
# detach("package:dplyr") may need to load plyr first and if already loaded run this to detach the dplyr then load after plyr
library(plyr)
library(dplyr)
...
# something wrong with this code MSL May 19 2019
